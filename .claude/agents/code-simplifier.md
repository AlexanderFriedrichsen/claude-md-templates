...
- **Redundant types**: type annotations that add no information (e.g., annotating
  a literal assignment), overly complex generics
...
2. **[file:line]** Flatten nested conditional
   - Before: [snippet]
   - After: [snippet]
   - Reason: [why this is simpler]
