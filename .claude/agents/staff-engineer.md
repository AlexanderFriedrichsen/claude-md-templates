...
## When Reviewing a Plan (/plans/current-plan.md)
...
- TypeScript strict compliance — no `any`, no `@ts-ignore`, proper type narrowing
- Dependency justification — is every new package truly needed?

### [PROJECT-SPECIFIC] Plan Review Criteria

<!-- Add your project-specific review criteria here. Examples: -->
...
- TypeScript strict — no `any`, no `@ts-ignore`, proper type narrowing?
...
<!-- Add your project-specific code review criteria here. Examples: -->
